...
write.csv(pollsummary,"pollsummary16.csv", row.names = FALSE)
write.csv(plantsummary,"plantsummary16.csv", row.names = FALSE)
write.csv(pollspeciesinfo, "pollspeciesinfo16.csv", row.names = FALSE)
write.csv(plantspeciesinfo, "plantspeciesinfo16.csv", row.names = FALSE)
write.csv(temp.summary, "tempsummary16.csv", row.names = FALSE)
