...
write.csv(pollspeciesinfo, "pollspeciesinfo6.csv", row.names = FALSE)
write.csv(plantspeciesinfo, "plantspeciesinfo6.csv", row.names = FALSE)
write.csv(temp.summary, "tempsummary6.csv", row.names = FALSE)
