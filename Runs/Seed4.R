...
write.csv(pollsummary,"pollsummary4.csv", row.names = FALSE)
write.csv(plantsummary,"plantsummary4.csv", row.names = FALSE)
write.csv(pollspeciesinfo, "pollspeciesinfo4.csv", row.names = FALSE)
write.csv(plantspeciesinfo, "plantspeciesinfo4.csv", row.names = FALSE)
write.csv(temp.summary, "tempsummary4.csv", row.names = FALSE)
