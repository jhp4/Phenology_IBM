...
write.csv(pollsummary,"pollsummary17.csv", row.names = FALSE)
write.csv(plantsummary,"plantsummary17.csv", row.names = FALSE)
write.csv(pollspeciesinfo, "pollspeciesinfo17.csv", row.names = FALSE)
write.csv(plantspeciesinfo, "plantspeciesinfo17.csv", row.names = FALSE)
write.csv(temp.summary, "tempsummary17.csv", row.names = FALSE)
