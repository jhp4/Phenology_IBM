...
write.csv(pollsummary,"pollsummary9.csv", row.names = FALSE)
write.csv(plantsummary,"plantsummary9.csv", row.names = FALSE)
write.csv(pollspeciesinfo, "pollspeciesinfo9.csv", row.names = FALSE)
write.csv(plantspeciesinfo, "plantspeciesinfo9.csv", row.names = FALSE)
write.csv(temp.summary, "tempsummary9.csv", row.names = FALSE)
