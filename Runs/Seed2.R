...
write.csv(pollsummary,"pollsummary2.csv", row.names = FALSE)
write.csv(plantsummary,"plantsummary2.csv", row.names = FALSE)
write.csv(pollspeciesinfo, "pollspeciesinfo2.csv", row.names = FALSE)
write.csv(plantspeciesinfo, "plantspeciesinfo2.csv", row.names = FALSE)
write.csv(temp.summary, "tempsummary2.csv", row.names = FALSE)
