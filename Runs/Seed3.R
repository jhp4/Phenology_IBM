...
write.csv(pollsummary,"pollsummary3.csv", row.names = FALSE)
write.csv(plantsummary,"plantsummary3.csv", row.names = FALSE)
write.csv(pollspeciesinfo, "pollspeciesinfo3.csv", row.names = FALSE)
write.csv(plantspeciesinfo, "plantspeciesinfo3.csv", row.names = FALSE)
write.csv(temp.summary, "tempsummary3.csv", row.names = FALSE)
