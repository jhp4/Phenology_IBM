...
write.csv(pollsummary,"pollsummary15.csv", row.names = FALSE)
write.csv(plantsummary,"plantsummary15.csv", row.names = FALSE)
write.csv(pollspeciesinfo, "pollspeciesinfo15.csv", row.names = FALSE)
write.csv(plantspeciesinfo, "plantspeciesinfo15.csv", row.names = FALSE)
write.csv(temp.summary, "tempsummary15.csv", row.names = FALSE)
