...
write.csv(plantsummary,"plantsummary7.csv", row.names = FALSE)
write.csv(pollspeciesinfo, "pollspeciesinfo7.csv", row.names = FALSE)
write.csv(plantspeciesinfo, "plantspeciesinfo7.csv", row.names = FALSE)
write.csv(temp.summary, "tempsummary7.csv", row.names = FALSE)
